...
import { addInstallment, loanList } from '../../actions/loan';
            ...
            <Grid item xs={10} style={{ margin: '0 auto' }}>
                <Paper>
                    ...
                    <Formik
                        initialValues={{
                            title: '',
                            amount: filteredLoan?.[0]?.monthlyInstallment,
                            date: '',
                            loanId: '',
                        }}
                        ...
                        onSubmit={(values) => {
                            ...
                            dispatch(addInstallment(values, id));
                                ...
                                <Grid item xs={12} className={classes.inputGroups}>
                                    <div class="mb-2">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            defaultValue={
                                                filteredLoan?.[0]?.monthlyInstallment
                                                    ? filteredLoan?.[0]?.monthlyInstallment
                                                    : values.amount
                                            }
                                            name="amount"
