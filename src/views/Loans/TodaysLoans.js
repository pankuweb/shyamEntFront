...
import { closeLoan, getTodaysLoan, filteredLoans, loanList } from '../../actions/loan';
import TodaysLoanReport from '../Reports/TodaysLoanReport';
...
const TodaysLoans = () => {
    ...
    const AllLoans = ListLoans?.current_day_loans?.data?.result ? ListLoans?.current_day_loans?.data?.result : ListLoans?.list?.loan;
    ...
    const usersData = unClosedLoans?.map((item, index) => {
        return {
                                ...
                                <Grid item xs={12} className={classes.flex}>
                                    ...
                                    <Grid item xs={10} className={classes.flex}>
                                        ...
                                        <Grid item xs={3} className={classes.filterInputs} style={{ marginTop: '10px' }}>
                                            <TodaysLoanReport loans={unClosedLoans} />
                                        </Grid>
                                    </Grid>
                                </Grid>
                            </form>
...
export default connect(null, { loanList })(TodaysLoans);
