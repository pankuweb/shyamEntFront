...
const LoanReports = () => {
    ...
    const usersData = filteredLoanList?.map((item, index) => {
        ...
        return {
            ...
            paidInstallments: checkInst[0]?.amount,
            pendingAmount: pendingAmount,
            Action: item,
            totalCollections: collectionsArr?.reduce((accumulator, current) => accumulator + current, 0),
        };
    });
    ...
    return (
        <Grid container spacing={gridSpacing}>
            <Grid item xs={12}>
                <Card>
                    <h3 className={classes.title}>Daily Collection Reports</h3>
                    <Formik
                        initialValues={{
                            start: '',
                            end: '',
                            ...
                            >
                                <Grid item xs={12} className={classes.flex}>
                                    ...
                                    <Grid item xs={4} className={classes.filterInputs}>
                                        <CollectionReport loans={usersData} />
                                    </Grid>
                                </Grid>
                            </form>
                        )}
                                            ...
                                            <table class="table table-bordered table-sm">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {usersData?.reduce(
                                                                (accumulator, current) => accumulator + current.paidInstallments,
                                                                0
                                                            )}
                                                        </td>
                                                    </tr>
...
export default connect(null, { loanList })(LoanReports);
